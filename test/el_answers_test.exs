defmodule ElAnswersTest do
  ...
  test "most_expensive_per_type/1 works with mock data" do
    expected = [book: [%{author: "liss", chapters: ["one", "two", "three"], price: 29.99, title: "foo", type: "book", year: 1999},
      ...
      cd: [%{author: "μ's", price: 20.99, title: "baz", tracks: [%{name: "one", seconds: 300}, %{name: "two", seconds: 3330}], type: "cd", year: 2000},
        %{author: "hanayo", price: 19.99, title: "baz", tracks: [%{name: "one", seconds: 3601}], type: "cd", year: 2000},
    ...
    assert MostExpensive.run(@mock_data) == expected
  end
