defmodule MostExpensiveTest do
  ...
  test "run/1 works with mock data" do
    ...
    expected = [book: [%{author: "liss", chapters: ["one", "two", "three"], price: 29.99, title: "foo", type: "book", year: 1999},
             ...
             %{author: "mary", chapters: ["Journal from 1987", "two", "three"], price: 15.99, title: "Journals", type: "book", year: 1999}],
            cd: [%{author: "μ's", price: 20.99, title: "Love Live!", tracks: [%{name: "Bokura wa Ima no Naka de (Live 2013)", seconds: 300}, %{name: "two", seconds: 3330}],
               type: "cd", year: 2000}, %{author: "hanayo", price: 19.99, title: "baz", tracks: [%{name: "one", seconds: 3601}], type: "cd", year: 2000},
             %{author: "Tomoe Nagisa", price: 18.99, title: "Cheeses I Came Back For", tracks: [%{name: "one", seconds: 180}, %{name: "Mascarpone in 2014", seconds: 200}],
               type: "cd", year: 2000}, %{author: "rin", price: 18.99, title: "baz", tracks: [%{name: "one", seconds: 180}, %{name: "two", seconds: 200}], type: "cd", year: 2000},
